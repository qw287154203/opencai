...
class CreateWfklsfTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('wfklsf', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('clwdx')->unsigned()->default('0');
