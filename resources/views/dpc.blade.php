...
<html>
	<head>
		...
		<title>【福彩3D|排列3开奖结果】中国福利彩票3d开奖结果字迷、走势图 - 18彩票开奖网</title>
		<meta name="keywords" content="3d开奖结果,3d试机号,3d走势图,3d字谜,福彩3d开奖结果,3d开机号" />
		<meta name="description" content="18彩票开奖网中国福利彩票3d开奖结果今天跨度走势图带连线专业版、试机号字迷图迷总汇太湖钓叟、开机号码查询。" />
							...
							<div class="haomaline">
								...
								<div class="numberqu">
									...
									<div class="kajianhaoPar">
										<div class="kajianhao">
											<ul id="jnumber">
												<li class="numblueHead numred" style="padding-top: 0px; line-height: 36px;">{{$data['current']['num1']}}</li>
												<li class="numblueHead numred" style="padding-top: 0px; line-height: 36px;">{{$data['current']['num2']}}</li>
												<li class="numblueHead numred" style="padding-top: 0px; line-height: 36px;">{{$data['current']['num3']}}</li>
											</ul>
										</div>
							...
							<tr>
								...
								<td class="blueqiu">
									<ul style="width:240px">
										<li class="numblue numredkong" style="color:#012537">{{$v['num1']}}</li>
										<li class="numblue numredkong" style="color:#012537">{{$v['num2']}}</li>
										<li class="numblue numredkong" style="color:#012537">{{$v['num3']}}</li>
									</ul>
								</td>
								<td>{{$v["sum"]}}</td>
				...
				if(data != undefined){
					if($('.preDrawIssue')[0].innerHTML != data.current.turnNum){
						...
						for(let v of data.history){
							...
							$('#tabData').append('<tr><td>'+v.openTime+'</td><td>'+v.turnNum+'</td><td class="blueqiu"><ul style="width:240px"><li class="numblue numredkong" style="color:#012537">'+v.num1+'</li><li class="numblue numredkong" style="color:#012537">'+v.num2+'</li><li class="numblue numredkong" style="color:#012537">'+v.num3+'</li></ul></td><td>'+v.sum+'</td><td '+dx+'>'+v.dx+'</td><td '+ds+'>'+v.ds+'</td></tr>');
						}
					}
				}
