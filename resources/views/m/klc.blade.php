				...
				<div class="headNum" id="headerData">
					...
					<div class="divline drawCodel">
						<ul id="num" class="sscli">
							<li style="padding-top: 0px; line-height: 0.25rem;">{{$data['current']['num1']}}</li>
							<li style="padding-top: 0px; line-height: 0.25rem;">{{$data['current']['num2']}}</li>
							<li style="padding-top: 0px; line-height: 0.25rem;">{{$data['current']['num3']}}</li>
							<li style="padding-top: 0px; line-height: 0.25rem;">{{$data['current']['num4']}}</li>
							<li style="margin-right: 0px; padding-top: 0px; line-height: 0.25rem;">{{$data['current']['num5']}}</li>
						</ul>
					</div>
					<div class="divline drawCodel tiger">
						<ul id="hlh" class="pk10li longhu">
							<li>{{$data['current']['lh1']}}</li>
							<li>{{$data['current']['lh2']}}</li>
							<li>{{$data['current']['lh3']}}</li>
							<li class="li_after">{{$data['current']['lh4']}}</li>
	...
	function up(){
		...
		if(time == 0){
			...
			if(data != undefined && $('.preDrawIssue')[0].innerHTML != data.current.turnNum){
				...
				$('#hlh').children()[3].innerHTML = 5;
				$('#hlh').children()[6].innerHTML = data.current.sum;
				$('#hlh').children()[7].innerHTML = data.current.dx;
				$('#hlh').children()[8].innerHTML = data.current.ds;
				...
				for(let v of data.history){
					...
					$('#numlist').append('<div class="listline bortop001"><div class="leftspan leftspanw"><span class="boxflex"><span class="graytime">'+opentime+'</span><span class="graytime">'+turnnum+'</span></span></div><div class="rightspan"><div class="rightdiv padl0"><ul id="" class="sscli haomali listli displayblock"><li>'+v.num1+'</li><li>'+v.num2+'</li><li>'+v.num3+'</li><li>'+v.num4+'</li><li class="li_after">'+v.num5+'</li></ul><ul id="" class="syxwlilist ssclilistxt listli lhlist"><li style="color:#f12d35">'+v.sum+'</li><li>'+v.dx+'</li><li>'+v.ds+'</li><li class="li_after">'+v.lh1+'</li><li>'+v.lh2+'</li><li>'+v.lh3+'</li><li>'+v.lh4+'</li></ul></div></div></div>');
				}
