				...
				<div class="headNum" id="headerData">
					...
					<div class="divline drawCodel">
						<ul id="num" class="pk10li numberbox">
							<li class="nub{{$data['current']['num1']}}"></li>
							<li class="nub{{$data['current']['num2']}}"></li>
							<li class="nub{{$data['current']['num3']}}"></li>
							<li class="nub{{$data['current']['num4']}}"></li>
							<li class="nub{{$data['current']['num5']}}"></li>
							<li class="nub{{$data['current']['num6']}}"></li>
							<li class="nub{{$data['current']['num7']}}"></li>
							<li class="nub{{$data['current']['num8']}}"></li>
							<li class="nub{{$data['current']['num9']}}"></li>
							<li class="nub{{$data['current']['num10']}} li_after"></li>
						</ul>
					</div>
					<div class="divline drawCodel tiger">
						<ul id="hlh" class="pk10li longhu">
							<li class="">{{$data['current']['lh1']}}</li>
							<li class="">{{$data['current']['lh2']}}</li>
							<li class="">{{$data['current']['lh3']}}</li>
							<li class="">{{$data['current']['lh4']}}</li>
							<li class="li_after">{{$data['current']['lh5']}}</li>
							...
							<div class="listline bortop001">
							   ...
							   <div class="rightspan">
							    <div class="rightdiv padl0">
							     <ul id="" class="pk10li haomali listli displayblock">
							      <li class="nubb{{$v['num1']}}"></li>
							      <li class="nubb{{$v['num2']}}"></li>
							      <li class="nubb{{$v['num3']}}"></li>
							      <li class="nubb{{$v['num4']}}"></li>
							      <li class="nubb{{$v['num5']}}"></li>
							      <li class="nubb{{$v['num6']}}"></li>
							      <li class="nubb{{$v['num7']}}"></li>
							      <li class="nubb{{$v['num8']}}"></li>
							      <li class="nubb{{$v['num9']}}"></li>
							      <li class="nubb{{$v['num10']}} li_after"></li>
							     </ul>
							     <ul id="" class="pk10li longhuli listli lhlist displaynone">
							      <li style="color:#f12d35">{{$v['sum']}}</li>
							      <li>{{$v['dx']}}</li>
							      <li>{{$v['ds']}}</li>
							      <li class="@php echo $v['lh1'] == '龙' ? 'longbg':'hubg'; @endphp"></li>
							      <li class="@php echo $v['lh2'] == '龙' ? 'longbg':'hubg'; @endphp"></li>
							      <li class="@php echo $v['lh3'] == '龙' ? 'longbg':'hubg'; @endphp"></li>
							      <li class="@php echo $v['lh4'] == '龙' ? 'longbg':'hubg'; @endphp"></li>
							      <li class="@php echo $v['lh5'] == '龙' ? 'longbg':'hubg'; @endphp li_after"></li>
							     </ul>
							    </div>
							   </div>
							  </div>
	...
	function up(){
		...
		if(time == 0){
			...
			if(data != undefined && $('.preDrawIssue')[0].innerHTML != data.current.turnNum){
				...
				$($('#num').children()[0]).attr('class','nub'+data.current.num1);
				$($('#num').children()[1]).attr('class','nub'+data.current.num2);
				$($('#num').children()[2]).attr('class','nub'+data.current.num3);
				$($('#num').children()[3]).attr('class','nub'+data.current.num4);
				$($('#num').children()[4]).attr('class','nub'+data.current.num5);
				$($('#num').children()[5]).attr('class','nub'+data.current.num6);
				$($('#num').children()[6]).attr('class','nub'+data.current.num7);
				$($('#num').children()[7]).attr('class','nub'+data.current.num8);
				$($('#num').children()[8]).attr('class','nub'+data.current.num9);
				$($('#num').children()[9]).attr('class','nub'+data.current.num10+' li_after');
				$('#hlh').children()[0].innerHTML = data.current.lh1;
				$('#hlh').children()[1].innerHTML = data.current.lh2;
				$('#hlh').children()[2].innerHTML = data.current.lh3;
				$('#hlh').children()[3].innerHTML = data.current.lh4;
				$('#hlh').children()[4].innerHTML = data.current.lh5;
				$('#hlh').children()[7].innerHTML = data.current.sum;
				$('#hlh').children()[8].innerHTML = data.current.dx;
				$('#hlh').children()[9].innerHTML = data.current.ds;
				...
				for(let v of data.history){
					...
					var lh2 = v.lh2 == '龙' ? 'longbg' : 'hubg';
					var lh3 = v.lh3 == '龙' ? 'longbg' : 'hubg';
					var lh4 = v.lh4 == '龙' ? 'longbg' : 'hubg';
					var lh5 = v.lh5 == '龙' ? 'longbg' : 'hubg';
					$('#numlist').append('<div class="listline bortop001"><div class="leftspan leftspanw"><span class="boxflex"><span class="graytime">'+opentime+'</span><span class="graytime">'+turnnum+'</span></span></div><div class="rightspan"><div class="rightdiv padl0"><ul id="" class="pk10li haomali listli displayblock"><li class="nubb'+v.num1+'"></li><li class="nubb'+v.num2+'"></li><li class="nubb'+v.num3+'"></li><li class="nubb'+v.num4+'"></li><li class="nubb'+v.num5+'"></li><li class="nubb'+v.num6+'"></li><li class="nubb'+v.num7+'"></li><li class="nubb'+v.num8+'"></li><li class="nubb'+v.num9+'"></li><li class="nubb'+v.num10+' li_after"></li></ul><ul id="" class="pk10li longhuli listli lhlist displaynone"><li style="color:#f12d35">'+v.sum+'</li><li>'+v.dx+'</li><li>'+v.ds+'</li><li class="'+lh1+'"></li><li class="'+lh2+'"></li><li class="'+lh3+'"></li><li class="'+lh4+'"></li><li class="'+lh5+' li_after"></li></ul></div></div></div>');
				}
