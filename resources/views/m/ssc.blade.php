				...
				<div class="headNum" id="headerData">
					...
					<div class="divline drawCodel tiger">
						<ul id="hlh" class="pk10li longhu">
							<li class="li_after">{{$data['current']['lh1']}}</li>
							   ...
							   <div class="rightspan">
							    <div class="rightdiv padl0">
							     ...
							     <ul id="" class="pk10li longhuli listli lhlist displaynone">
							      ...
							      <li>{{$v['dx']}}</li>
							      <li>{{$v['ds']}}</li>
							      <li class="@php echo $v['lh1'] == '龙' ? 'longbg':'hubg'; @endphp li_after"></li>
							     </ul>
							    </div>
							   </div>
							  </div>
	...
	function up(){
		...
		if(time == 0){
			...
			if(data != undefined && $('.preDrawIssue')[0].innerHTML != data.current.turnNum){
				...
				$('#hlh').children()[3].innerHTML = data.current.sum;
				$('#hlh').children()[4].innerHTML = data.current.dx;
				$('#hlh').children()[5].innerHTML = data.current.ds;
				...
				for(let v of data.history){
					...
					$('#numlist').append('<div class="listline bortop001"><div class="leftspan leftspanw"><span class="boxflex"><span class="graytime">'+opentime+'</span><span class="graytime">'+turnnum+'</span></span></div><div class="rightspan"><div class="rightdiv padl0"><ul id="" class="sscli haomali listli displayblock"><li>'+v.num1+'</li><li>'+v.num2+'</li><li>'+v.num3+'</li><li>'+v.num4+'</li><li class="li_after">'+v.num5+'</li></ul><ul id="" class="pk10li longhuli listli lhlist displaynone"><li style="color:#f12d35">'+v.sum+'</li><li>'+v.dx+'</li><li>'+v.ds+'</li><li class="'+lh1+'  li_after"></li></ul></div></div></div>');
				}
