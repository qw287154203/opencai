...
<html>
	<head>
		...
		<title>看PC蛋蛋幸运28开奖结果直播，PC蛋蛋幸运28走势图，稳赢技巧，来168彩票开奖网，官方数据！精准无延迟！</title>
		<meta name="keywords" content="PC蛋蛋幸运28开奖结果,PC蛋蛋幸运28开奖直播,PC蛋蛋幸运28走势图,PC蛋蛋幸运28稳赚技巧,PC蛋蛋幸运28稳赚方法" />
		<meta name="description" content="本站PC蛋蛋幸运28开奖结果直播、PC蛋蛋幸运28走势图、历史记录与官方实时同步，更有稳赚技巧分享，保存书签（Ctrl+D），下次打开更方便！" />
		<link rel="stylesheet" href="/static/css/headorfood.css" />
		<link rel="stylesheet" href="/static/css/pc_egxy28.css" />
				...
				if(data != undefined){
					if($('.preDrawIssue')[0].innerHTML != data.current.turnNum){
						...
						for(let v of data.history){
							...
							$('#tabData').append('<tr><td>'+v.openTime+'</td><td>'+v.turnNum+'</td><td class="blueqiu"><ul class="egxyul"><li class="numblue" style="color:#012537">'+v.num1+'</li><li class="numblue" style="color:#012537">'+v.num2+'</li><li class="numblue" style="color:#012537">'+v.num3+'</li></ul></td><td>'+v.sum+'</td><td '+dx+'>'+v.dx+'</td><td '+ds+'>'+v.ds+'</td></tr>');
						}
					}
				}
