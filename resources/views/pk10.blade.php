...
<html>
	<head>
		...
		<title>看北京PK10开奖结果直播，北京PK10走势图，稳赢技巧，来18彩票开奖网，官方数据！精准无延迟！</title>
		<meta name="keywords" content="北京PK10开奖结果,北京PK10开奖直播,北京PK10走势图,北京PK10稳赚技巧,北京PK10稳赚方法" />
		<meta name="description" content="本站北京PK10开奖结果直播、北京PK10走势图、历史记录与官方实时同步，更有稳赚技巧分享，保存书签（Ctrl+D），下次打开更方便！" />
		<link rel="stylesheet" href="/static/css/headorfood.css" />
		<link rel="stylesheet" href="/static/css/pk10kai.css" />
									...
									<div class="kajianhaoPar">
										<div class="kajianhao">
											<ul id="jnumber" class="numberbox">
												<li class="numsm{{$data['current']['num1']}} "></li>
												<li class="numsm{{$data['current']['num2']}} "></li>
												<li class="numsm{{$data['current']['num3']}} "></li>
												<li class="numsm{{$data['current']['num4']}} "></li>
												<li class="numsm{{$data['current']['num5']}} "></li>
												<li class="numsm{{$data['current']['num6']}} "></li>
												<li class="numsm{{$data['current']['num7']}} "></li>
												<li class="numsm{{$data['current']['num8']}} "></li>
												<li class="numsm{{$data['current']['num9']}} "></li>
												<li class="numsm{{$data['current']['num10']}} li_after"></li>
											</ul>
										</div>
					...
					<div class="jrsmhmtj jrsmhmtj_kai" id="jrsmhmtj">
						<table id="tabData" cellpadding="1" cellspacing="1" border="0">
							...
							<tr>
								...
								<td>
									<ul class="imgnumber">
										<li class="numsm{{$v["num1"]}} "></li>
										<li class="numsm{{$v["num2"]}} "></li>
										<li class="numsm{{$v["num3"]}} "></li>
										<li class="numsm{{$v["num4"]}} "></li>
										<li class="numsm{{$v["num5"]}} "></li>
										<li class="numsm{{$v["num6"]}} "></li>
										<li class="numsm{{$v["num7"]}} "></li>
										<li class="numsm{{$v["num8"]}} "></li>
										<li class="numsm{{$v["num9"]}} "></li>
										<li class="numsm{{$v["num10"]}} li_after"></li>
									</ul>
								</td>
								<td>{{$v["sum"]}}</td>
								...
								<td @php echo $v["lh5"] == "龙" ? "style=\"color:#f12d35\"" : ""; @endphp>{{$v["lh5"]}}</td>
							</tr>
							@endforeach
						</table>
					</div>
			...
			if(djs == 0){
				...
				if(data != undefined){
					if($('.preDrawIssue')[0].innerHTML != data.current.turnNum){
						...
						$($('#jnumber').children()[0]).attr('class','numsm'+data.current.num1);
						$($('#jnumber').children()[1]).attr('class','numsm'+data.current.num2);
						$($('#jnumber').children()[2]).attr('class','numsm'+data.current.num3);
						$($('#jnumber').children()[3]).attr('class','numsm'+data.current.num4);
						$($('#jnumber').children()[4]).attr('class','numsm'+data.current.num5);
						$($('#jnumber').children()[5]).attr('class','numsm'+data.current.num6);
						$($('#jnumber').children()[6]).attr('class','numsm'+data.current.num7);
						$($('#jnumber').children()[7]).attr('class','numsm'+data.current.num8);
						$($('#jnumber').children()[8]).attr('class','numsm'+data.current.num9);
						$($('#jnumber').children()[9]).attr('class','numsm'+data.current.num10);
						...
						for(let v of data.history){
							...
							var lhyi = v.lh1 == "龙" ? "style=\"color:#f12d35\"":"";
							var lher = v.lh2 == "龙" ? "style=\"color:#f12d35\"":"";
							var lhsan = v.lh3 == "龙" ? "style=\"color:#f12d35\"":"";
							var lhsi = v.lh4 == "龙" ? "style=\"color:#f12d35\"":"";
							var lhwu = v.lh5 == "龙" ? "style=\"color:#f12d35\"":"";
							$('#tabData').append('<tr><td>'+v.openTime+'</td><td>'+v.turnNum+'</td><td><ul class="imgnumber"><li class="numsm'+v.num1+' "><i>'+v.num1+'</i></li><li class="numsm'+v.num2+' "><i>'+v.num2+'</i></li><li class="numsm'+v.num3+' "><i>'+v.num3+'</i></li><li class="numsm'+v.num4+' "><i>'+v.num4+'</i></li><li class="numsm'+v.num5+' "><i>'+v.num5+'</i></li><li class="numsm'+v.num6+' "><i>'+v.num6+'</i></li><li class="numsm'+v.num7+' "><i>'+v.num7+'</i></li><li class="numsm'+v.num8+' "><i>'+v.num8+'</i></li><li class="numsm'+v.num9+' "><i>'+v.num9+'</i></li><li class="numsm'+v.num10+' li_after"><i>'+v.num10+'</i></li></ul></td><td>'+v.sum+'</td><td '+dx+'>'+v.dx+'</td><td '+ds+'>'+v.ds+'</td><td '+lhyi+'>'+v.lh1+'</td><td '+lher+'>'+v.lh2+'</td><td '+lhsan+'>'+v.lh3+'</td><td '+lhsi+'>'+v.lh4+'</td><td '+lhwu+'>'+v.lh5+'</td></tr>');
						}
					}
				}
