...
<html>
	<head>
		...
		<title>【体彩七星彩开奖结果】体彩七星彩开奖查询_体彩七星彩开奖号码 - 18彩票开奖网</title>
		<meta name="keywords" content="体彩七星彩开奖结果,体彩七星彩开奖信息,体彩七星彩开奖视频,体彩七星彩开奖走势图,江体彩七星彩开奖数据,体彩七星彩开奖历史,体彩七星彩开奖查询,体彩七星彩开奖直播,体彩七星彩开奖号码,体彩七星彩开奖记录" />
		<meta name="description" content="168彩票开奖网体彩七星彩开奖栏目提供最新体彩七星彩开奖结果查询、体彩七星彩开奖号码走势、体彩七星彩开奖时间、体彩七星彩今天开奖信息。" />
							...
							<div class="haomaline">
								...
								<div class="numberqu">
									...
									<div class="kajianhaoPar">
										<div class="kajianhao">
											<ul id="jnumber">
												<li class="numWeightblue">{{$data['current']['num1']}}</li>
												<li class="numWeightblue">{{$data['current']['num2']}}</li>
												<li class="numWeightblue">{{$data['current']['num3']}}</li>
												<li class="numWeightblue">{{$data['current']['num4']}}</li>
											</ul>
										</div>
					...
					<div class="jrsmhmtj jrsmhmtj_kai" id="jrsmhmtj">
						<table id="tabData" cellpadding="1" cellspacing="1" border="0">
							...
							<tr>
								...
								<td>{{$v["turnNum"]}}</td>
								<td class="blueqiu">
									<ul style="width:338px;max-width:338px">
				...
				if(data != undefined){
					if($('.preDrawIssue')[0].innerHTML != data.current.turnNum){
						...
						for(let v of data.history){
							...
							$('#tabData').append('<tr><td>'+v.openTime+'</td><td>'+v.turnNum+'</td><td class="blueqiu"><ul style="width:338px;max-width:338px"><li class="numblue" style="color:#012537">'+v.num1+'</li><li class="numblue" style="color:#012537">'+v.num2+'</li><li class="numblue" style="color:#012537">'+v.num3+'</li><li class="numblue" style="color:#012537">'+v.num4+'</li></ul></td><td>'+v.sum+'</td><td '+ds+'>'+v.ds+'</td></tr>');
						}
					}
				}
