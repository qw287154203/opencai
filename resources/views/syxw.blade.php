...
<html>
	<head>
		...
		<title>看11选5开奖结果直播，11选5走势图，稳赢技巧，来18彩票开奖网，官方数据！精准无延迟！</title>
		<meta name="keywords" content="11选5开奖结果,11选5开奖直播,11选5走势图,11选5稳赚技巧,11选5稳赚方法" />
		<meta name="description" content="本站11选5开奖结果直播、11选5走势图、历史记录与官方实时同步，更有稳赚技巧分享，保存书签（Ctrl+D），下次打开更方便！" />
		<link rel="stylesheet" href="/static/css/headorfood.css" />
		<link rel="stylesheet" href="/static/css/shishicai.css" />
							...
							<div class="haomaline">
								...
								<div class="numberqu">
									...
									<div class="kajianhaoPar">
										<div class="kajianhao">
											<ul id="jnumber">
												<li class="numblueHead">{{$data['current']['num1']}}</li>
												<li class="numblueHead">{{$data['current']['num2']}}</li>
												<li class="numblueHead">{{$data['current']['num3']}}</li>
												<li class="numblueHead">{{$data['current']['num4']}}</li>
												<li class="numblueHead">{{$data['current']['num5']}}</li>
											</ul>
										</div>
							...
							<tr>
								...
								<td class="blueqiu">
									<ul style="width:240px">
										<li class="sscnumblue" style="color:#012537">{{$v['num1']}}</li>
										<li class="sscnumblue" style="color:#012537">{{$v['num2']}}</li>
										<li class="sscnumblue" style="color:#012537">{{$v['num3']}}</li>
										<li class="sscnumblue" style="color:#012537">{{$v['num4']}}</li>
										<li class="sscnumblue" style="color:#012537">{{$v['num5']}}</li>
									</ul>
								</td>
								<td>{{$v["sum"]}}</td>
								...
								<td @php echo $v["qs"] == "顺子" ? "style=\"color:#f12d35\"" : ""; @endphp>{{$v["qs"]}}</td>
								<td @php echo $v["zs"] == "顺子" ? "style=\"color:#f12d35\"" : ""; @endphp>{{$v["zs"]}}</td>
								<td @php echo $v["hs"] == "顺子" ? "style=\"color:#f12d35\"" : ""; @endphp>{{$v["hs"]}}</td>
							</tr>
							@endforeach
						</table>
					</div>
				...
				if(data != undefined){
					if($('.preDrawIssue')[0].innerHTML != data.current.turnNum){
						...
						for(let v of data.history){
							...
							var qs = v.qs == "顺子" ? "style=\"color:#f12d35\"":"";
							var zs = v.zs == "顺子" ? "style=\"color:#f12d35\"":"";
							var hs = v.hs == "顺子" ? "style=\"color:#f12d35\"":"";
							$('#tabData').append('<tr><td>'+v.openTime+'</td><td>'+v.turnNum+'</td><td class="blueqiu"><ul style="width:240px"><li class="sscnumblue" style="color:#012537">'+v.num1+'</li><li class="sscnumblue" style="color:#012537">'+v.num2+'</li><li class="sscnumblue" style="color:#012537">'+v.num3+'</li><li class="sscnumblue" style="color:#012537">'+v.num4+'</li><li class="sscnumblue" style="color:#012537">'+v.num5+'</li></ul></td><td>'+v.sum+'</td><td '+dx+'>'+v.dx+'</td><td '+ds+'>'+v.ds+'</td><td '+lhyi+'>'+v.lh1+'</td><td '+qs+'>'+v.qs+'</td><td '+zs+'>'+v.zs+'</td><td '+hs+'>'+v.hs+'</td></tr>');
						}
					}
				}
